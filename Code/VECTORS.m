 classdef VECTORS
    methods(Static)
        ...
        % Store
        function GLOBAL=Store(GLOBAL,STEP,Mat_state,Int_var,MAT_POINT)
        ...
        % Update
        function [Mat_state,Int_var]=Update(Mat_state,Int_var)
        ...
        % Update initial
        function [Mat_state,Int_var,STEP]=Update_ini(...
